#Abaixo, estão dispostas todas as funções que eu utilizei neste código.
def estrelinha():
    print("*" * 30)
...
def computador_escolhe_jogada(n,m):
    ...
    if (equação >= 1):
        ...
        print("O computador retirou {} cartas da mesa...".format(equação))
        cartas_atuais_pc = b

        return cartas_atuais_pc
...
def usuario_escolhe_jogada(n,m):
    ...
    a2 = n - a
    print("Você retirou {a} cartas da mesa. Sendo assim, agora restam {a2} cartas na mesa...".format(a,a2))

    cartas_atuais_usuario = a2
...
def Menu():
    ...
    if (escolha == 1):
        #Tentar substituir por Select Case
        partida()
